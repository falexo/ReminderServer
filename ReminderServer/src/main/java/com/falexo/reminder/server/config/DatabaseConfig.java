...
/**
 * Created by newman on 09.02.2016.
 */
@Configuration
@EnableJpaRepositories("com.falexo.reminder.server.repository")
...
public class DatabaseConfig {
    ...
    private Properties getHibernateProperties() {
        try {
            ...
            throw new IllegalArgumentException("can't find file hibernate.properties in the classpath!", e);
        }
    }
}
